...
app.post("/submit", (req, res) => {
  ...
  //Then:
  const random_adj = adj[Math.floor(Math.random()*1346)]
  const random_noun = noun[Math.floor(Math.random()*4307)]
  var band_name = random_adj + " " + random_noun
  res.render('index.ejs', {
    nameGenerator: band_name
  })
